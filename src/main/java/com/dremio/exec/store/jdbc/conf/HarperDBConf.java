...
@SourceType(value = "HarperDBARP", label = "HarperDB",uiConfig = "harperdb-layout.json")
public class HarperDBConf extends AbstractArpConf<HarperDBConf> {
  private static final String ARP_FILENAME = "arp/implementation/harperdb-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.harperdb.HarperDBDriver";
